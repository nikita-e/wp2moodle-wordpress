...
Plugin URI: https://github.com/nikita-e/wp2moodle-wordpress
...
Version: 1.9
Author2: Tim St.Clair
Author: Nikita E.
Author2 URI: http://frumbert.org
Author URI: http://github.com/nikita-e
License: GPL2
*/
...
function wp2m_activate() {
	...
	add_option('wp2m_moodle_url', 'http://yourmoodlesite.com/moodle');
	add_option('wp2m_redirect_url', 'http://yoursite.com/?page_id=');
	add_option('wp2m_redirect_title', 'Moodle');
	add_option('wp2m_redirect_description', 'Click to go to moodle');
...
function wp2m_deactivate() {
	...
	add_option('wp2m_redirect_url');
	add_option('wp2m_redirect_title');
	add_option('wp2m_redirect_description');
...
function toolbar_link($wp_admin_bar) {
	$args = array(
		'id' => 'redirect_button',
		'title' => get_option(wp2m_redirect_title), 
		'href' => get_option(wp2m_redirect_url) , 
		'meta' => array(
			'class' => 'redirect_button', 
			'title' => get_option(wp2m_redirect_description), 
			)
	);
...
function wp2m_register_settings() {
	...
	register_setting( 'wp2m-settings-group', 'wp2m_redirect_url' );
	register_setting( 'wp2m-settings-group', 'wp2m_redirect_title' );
	register_setting( 'wp2m-settings-group', 'wp2m_redirect_description' );
