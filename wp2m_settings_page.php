...
<form method="post" action="options.php">
    ...
    <table class="form-table">
		...
		<tr valign="top">
            <th scope="row">Moodle redirect button URL</th>
            <td><input type="text" name="wp2m_redirect_url" value="<?php echo get_option('wp2m_redirect_url'); ?>" size="60" />
            <div class="description">Plugin will add shortcut to admin panel to redirect users to your site.</div>
            </td>
        </tr>
		
		<tr valign="top">
            <th scope="row">Moodle redirect button title</th>
            <td><input type="text" name="wp2m_redirect_title" value="<?php echo get_option('wp2m_redirect_title'); ?>" size="60" />
            <div class="description">Plugin will add shortcut to admin panel to redirect users to your site.</div>
            </td>
        </tr>
		
		<tr valign="top">
            <th scope="row">Moodle redirect button description</th>
            <td><input type="text" name="wp2m_redirect_description" value="<?php echo get_option('wp2m_redirect_description'); ?>" size="60" />
            <div class="description">Plugin will add shortcut to admin panel to redirect users to your site.</div>
            </td>
        </tr>
